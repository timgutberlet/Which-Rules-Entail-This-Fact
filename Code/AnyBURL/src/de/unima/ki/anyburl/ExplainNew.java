...
public class ExplainNew {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		String inputRulePath = mainFolder + "/input_rules.txt";
		// the prefix of the path where the rules will be stores, -DURATION will be added
		String rulePath = mainFolder + "/tmp/rules";
		...
		String emptyPath = mainFolder + "/tmp/empty.txt";
		...
		/*
		This will is the intresting output for our problem
		 */

		String outputDeletePathVB = mainFolder + "/rules_implying_the_target.txt";
		...
		String outputRankingsTmpPath = mainFolder + "/tmp/tmp_ranking.txt";
		...
		/*
		This is not part of our problem. Here the rules for the target relation(s) are learned.
		 */
		...
		File inputRuleFile = new File(inputRulePath);

		if(inputRuleFile.exists()){
			Settings.PATH_RULES = inputRulePath;
		} else {
